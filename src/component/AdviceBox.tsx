...
const AdviceBox = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen">
            <div className="w-[343px] h-[315px] bg-darkGrayishBlue rounded-md flex justify-center items-center">
                <div className="text-center">
                    <div>
                        <div className="text-neonGreen text-s tracking-wide text-normal pt-6"><span>ADVICE #{slip_id}</span></div>
                    </div>
                    <div>
                        <div className="text-lightCyan text-l p-6">{advice ? <p>{advice.advice}</p> : <p>Loading advice...</p>}</div>
                    </div>
            ...
            <div className="relative bottom-8 z-10 pt-2">
                <button className="relative rounded-full w-[64px] h-[64px] bg-neonGreen" onClick={handleAdviceRefresh}>
